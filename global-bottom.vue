...
const { currentSlideNo, total, currentSlideRoute, slides } = useNav()
...
<template>
    ...
    <footer class="absolute bottom-0 right-0 p-2 opacity-40">010153002 Computer Programming {{ $slidev.configs.semester }} - Page {{ currentSlideNo }} / {{ total }}</footer>
</template>
